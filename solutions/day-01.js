...
// Одноклассники попросили вас скопировать для них документы. Вы знаете, что одноклассников n, а в документе m страниц.
// Ваша задача — подсчитать, сколько чистых страниц вам понадобится. Если n < 0 или m < 0, верните 0.
// Пример:
// n = 5, m = 5: 25
// n = -5, m = 5: 0
...
// Реализуйте функцию, преобразующую заданное логическое значение в его строковое представление.
